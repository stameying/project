...
Set<String> schoolList = new HashSet<String>();
schoolList = jedis.smembers("School");
Iterator it1 = schoolList.iterator();
while (it1.hasNext())
{
String schoolName = (String)it1.next();
Set<String> professorList = new HashSet<String>();
professorList = jedis.smembers(schoolName);
