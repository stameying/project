...
public ArrayList<Integer> indexString(String inputString)
{
	...
	ArrayList<String> wordList = this.parseInterest(input);
	int index = 0;
...
public ArrayList<String> parseInterest(String input)
{
	...
	{
		String indexword = result.get(i);
		System.out.println(i + ": " + indexword);
	}
